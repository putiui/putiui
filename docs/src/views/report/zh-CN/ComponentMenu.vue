...
<script>
    ...
    import ComponentMenuBasic from '../demo/zh-CN/ComponentMenuBasic.vue';
    import ComponentMenuPlacement from '../demo/zh-CN/ComponentMenuPlacement.vue';
    import ComponentMenuVertical from '../demo/zh-CN/ComponentMenuVertical.vue';
    export default {
        name: 'ComponentMenu',
        data() {
            return {
        ...
        components: {
            ComArticle,
            Demo,
            ComponentMenuBasic: ComponentMenuBasic,
            ComponentMenuPlacement: ComponentMenuPlacement,
            ComponentMenuVertical: ComponentMenuVertical
        }
    }
